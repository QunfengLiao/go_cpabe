...
- [ ] T001 [Setup] 验证 backend、desktop 和规格目录结构。
...
- [ ] T011 [Frontend] 实现 Electron 桌面端工作流和可解释性视图。
...
- [ ] T016 [Docs] 执行关键中文注释和可读性检查，确保核心业务、安全、认证、权限、Token、
  密码、文件上传、加密算法和访问控制逻辑解释设计原因和安全边界，且不存在无意义逐行注释。
